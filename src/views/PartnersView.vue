  ...
  <main>
    ...
    <section class="section partners-intro">
      <div>
        ...
        <p>成长合伙人不仅关注成绩，也关注学生的目标感、学习方法、自我管理、表达能力和心理能量。学校通过导师陪伴、课程支持、项目指导和家校沟通，让每个孩子在真实关系中被看见、被理解、被支持。</p>
      </div>
      <HeartTeam :photos="heartPhotos" />
    </section>
  </main>
</template>
...
import { heartPhotos } from '../data/siteData'
</script>
